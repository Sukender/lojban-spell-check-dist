...
- **libreoffice**: [Lojban LibreOffice / OpenOffice spell check dictionary](Lojban LibreOffice and OpenOffice dictionary.oxt)
...
- **firefox**: [Lojban Firefox spell check dictionary](Lojban Firefox dictionary.xpi)
